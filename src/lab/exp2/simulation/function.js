window.view = {
	...
	validateRectangleInputs: function() {
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right triangle requires 2 arguments i.e the length of the base and the height of the triangle. Try again.')
		else if ( b !== 'float' )
	...
	displayFunctionForRectangle: function() {
		document.getElementById('functionRectangle').innerHTML += 'float area_right_triangle (float a,float b)<br>{<br> &emsp; float area = (a*b)/2;<br> &emsp; return area;<br>}'
	},
